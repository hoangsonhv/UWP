    ...
    public sealed partial class LapMain : Page
    {
        ...
        private void ListViewItem_Tapped(object sender, TappedRoutedEventArgs e)
        {
            ...
            switch (selectedItem.MenuPage)
            {
                ...
                case "Contact": Frame.Navigate(typeof(Labs2.Contact)); break;
                case "Home": Frame.Navigate(typeof(Labs2.Home)); break;
                case "Customer": Frame.Navigate(typeof(Labs2.Customer)); break;
                case "Mail": Frame.Navigate(typeof(Labs2.Mail)); break;
            }
        }
    }
}
